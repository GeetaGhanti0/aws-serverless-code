...
import { CmgAwsAccountIdParameter } from '.'

describe(CmgAwsAccountIdParameter, () => {
    let stack: Stack
    ...
    beforeAll(()=> {
        ...
        parameter = CmgAwsAccountIdParameter(stack)

        parameterName = ssmParameterName(stack, 'cmg-aws-account-id')
    })
