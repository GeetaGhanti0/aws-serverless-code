...
import { ResponseKeyArnParameter } from '.'

describe(ResponseKeyArnParameter, () => {
    let stack: Stack
    ...
    beforeAll(()=> {
        ...
        parameter = ResponseKeyArnParameter(stack)

        parameterName = ssmParameterName(stack, 'response-key-arn')
    })
